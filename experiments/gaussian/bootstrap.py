...
torch.save(raw_pred_arr, 'YOUR_DIR_HERE/bootstrap_raw_pred_arr.pt')
torch.save(pred_arr, 'YOUR_DIR_HERE/bootstrap_pred_arr.pt')
torch.save(true_arr, 'YOUR_DIR_HERE/bootstrap_true_arr.pt')
torch.save(unc_arr, 'YOUR_DIR_HERE/bootstrap_unc_arr.pt')
torch.save(z_score_arr, 'YOUR_DIR_HERE/bootstrap_z_score_arr.pt')
torch.save(z_score_bc_arr, 'YOUR_DIR_HERE/bootstrap_z_score_bc_arr.pt')


torch.save(llr_pred_arr, 'YOUR_DIR_HERE/bootstrap_llr_pred_arr.pt')
torch.save(llr_true_arr, 'YOUR_DIR_HERE/bootstrap_llr_true_arr.pt')
torch.save(llr_unc_arr, 'YOUR_DIR_HERE/bootstrap_llr_unc_arr.pt')
