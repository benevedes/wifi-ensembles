...
torch.save(raw_pred_arr, 'YOUR_DIR_HERE/partition_chi2_raw_pred_arr.pt')
torch.save(pred_arr, 'YOUR_DIR_HERE/partition_chi2_pred_arr.pt')
torch.save(true_arr, 'YOUR_DIR_HERE/partition_chi2_true_arr.pt')
torch.save(unc_arr, 'YOUR_DIR_HERE/partition_chi2_unc_arr.pt')
torch.save(z_score_arr, 'YOUR_DIR_HERE/partition_chi2_z_score_arr.pt')
torch.save(z_score_bc_arr, 'YOUR_DIR_HERE/partition_chi2_z_score_bc_arr.pt')


torch.save(llr_pred_arr, 'YOUR_DIR_HERE/partition_chi2_llr_pred_arr.pt')
torch.save(llr_true_arr, 'YOUR_DIR_HERE/partition_chi2_llr_true_arr.pt')
torch.save(llr_unc_arr, 'YOUR_DIR_HERE/partition_chi2_llr_unc_arr.pt')
